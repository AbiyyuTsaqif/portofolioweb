...
>
      ...
      <div key={project.name} className="space-y-2">
        ...
        <div className="px-1">
          {project.link ? (
            ...
            <span className="font-base inline-block font-[450] text-zinc-900 dark:text-zinc-50 opacity-60 cursor-default">
              {project.name}
            </span>
          )}
  ...
  <a
    ...
    href="https://www.github.com/AbiyyuTsaqif"
    target="_blank"
    rel="noopener noreferrer"
  >
    github.com/AbiyyuTsaqif
  </a>
</p>
</motion.section>
...
<p className="mt-8 text-zinc-600 dark:text-zinc-400">
  ...
  <a
    className="underline dark:text-zinc-300"
    href="https://www.linkedin.com/in/abiyyu-tsaqif/"
    target="_blank"
    rel="noopener noreferrer"
  >
    linkedin.com/in/abiyyu-tsaqif
  </a>
</p>
  </div>
</motion.section>
